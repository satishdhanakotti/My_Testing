...
public class Base {
	...
	public static WebDriver Browser() throws IOException {
		...
		fis = new FileInputStream("C:\\Users\\Satish\\eclipse-workspace\\ReadExcel\\ExcelInput-2021-10-01\\src\\main\\java\\resources\\Config.properties");
		prop = new Properties();
		prop.load(fis);
	...
	public static List<Map<String,String>> getExcelData(int num) throws IOException {
		...
		file = new File("C:\\Users\\Satish\\eclipse-workspace\\ReadExcel\\ExcelInput-2021-10-01\\src\\main\\java\\resources\\Soluship_User_Inputs.xlsx");
